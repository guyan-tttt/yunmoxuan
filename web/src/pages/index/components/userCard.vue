<template>
  ...
  <div class="mb-3 w-full bg-white border border-gray-200 rounded-lg dark:bg-gray-800 dark:border-gray-700">
    ...
    <div class="flex flex-col items-center pb-6">
      <img class="w-15 h-15 mb-3 rounded-full shadow-lg" src="../../../assets/1.jpg" alt="Bonnie image" />
      <h5 class="mb-1 text-xl font-medium text-gray-900 dark:text-white">guyan</h5>
      <span class="text-sm text-gray-500 dark:text-gray-400"> xnaocxnaoscacs </span>
      <div class="flex mt-4 space-x-3 md:mt-5">
        <span>
          <a data-tooltip-target="github-tooltip-bottom" data-tooltip-placement="bottom" href="#" target="_blank">
            <svg
              t="1682482283799"
              class="icon"
        ...
        <span>
          <a href="#" data-tooltip-target="csdn-tooltip-bottom" data-tooltip-placement="bottom" target="_blank">
            <svg
              t="1682483295332"
              class="icon"
              viewBox="0 0 1024 1024"
        ...
        <span>
          <a href="#" data-tooltip-target="gitee-tooltip-bottom" data-tooltip-placement="bottom" target="_blank">
            <svg
              t="1682483184788"
              class="icon"
              viewBox="0 0 1024 1024"
